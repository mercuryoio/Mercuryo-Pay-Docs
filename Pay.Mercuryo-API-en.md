...
*Step 1*: ![Step 1](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-1.png?raw=true "Step 1")
 


*Step 2*: ![Step 2](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-2.png?raw=true "Step 2")  


*Step 3*: After saving the new store in the second step, api_key and secret_key are automatically generated. 
![Step 3-1](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-3.png?raw=true "Step 3-1")
![Step 3-2](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-3-1.png?raw=true "Step 3-2") 


*Step 4*: Go to the Payment form and  try to pay: system redirects to the payment form (which can be customized for you). 
![Step 4-1](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-4.png?raw=true "Step 4-1")
![Step 4-2](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-4-1.png?raw=true "Step 4-2")
![Step 4-3](https://github.com/IgorKurochkin/Mercuryo-API/blob/main/Step-4-2.png?raw=true "Step 4-3") 
